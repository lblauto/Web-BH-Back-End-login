...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="home-page.css">
    <title>WELCOME TO LBLSTORE</title>
</head>
<body>
    <header>
        <div class="header-container">
            <div class="header-system">
                ...
                <div class="header-item1">
                    <a href="login.php"><span><i class="fa-solid fa-user"></i></span>Tài khoản</a>
            ...
            <div class="header-center">
                <div class="logo">
                    <a href="#"><img src="image/LBLlogo.png" alt=""></a>
                </div>
                <div class="search">
                    <select class="select">
            ...
            <div class="shop-website-item2s">
                <div class="shop-website-item2">
                    <div class="shop-website-item2-img">
                        <a href="#"><img src="image/anh1.jpg" alt="" style="position: relative; width: 97%; display: flex; justify-content: space-between; margin: 0 auto;"></a>
                        <a href="#"><img src="image/anh2.jpg" alt="" style="position: relative; width: 97%; display: flex; justify-content: space-between; margin: 0 auto;"></a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="shop-website-item3-left">
                            ...
                            <div class="shop-website-item3-left-center">
                                <div class="item3-left-center-items">
                                    <a href="#"><img src="image/item3-sp.jpg" alt=""></a>
                                    <a href="#" style="text-decoration: none;"><p>Đồ dùng nam</p></a>
                                </div>
                                <div class="item3-left-center-items">
                                    <a href="#"><img src="image/item3-sp2.jpg" alt=""></a>
                                    <a href="#" style="text-decoration: none;"><p>Phụ kiện nam</p></a>
                                </div>
                                <div class="item3-left-center-items">
                                    <a href="#"><img src="image/item3-sp3.jpg" alt=""></a>
                                    <a href="#" style="text-decoration: none;"><p>Giày dép nam</p></a>
                                </div>
                                <div class="item3-left-center-items">
                                    <a href="#"><img src="image/item3-sp4.jpg" alt=""></a>
                                    <a href="#" style="text-decoration: none;"><p>Áo nam</p></a>
                                </div>
                            </div>
    ...
    <footer>
        <div class="container__footer">
            <div class="box__footer">
                <div class="logo">
                    <a href="#"><img src="Images/LBLlogo.png" alt=""></a>
                </div>
                <div class="terms">
                    <p>Chào mừng bạn đến với LBLSTORE - điểm đến thời trang hàng đầu! Chúng tôi tự hào mang đến cho bạn những sản phẩm thời trang tuyệt vời nhất, từ trang phục đến phụ kiện, giúp bạn tỏa sáng và thể hiện phong cách riêng của mình. Hãy cùng khám phá và tìm thấy những món đẹp mắt tại cửa hàng của chúng tôi.</p>
                </div>
            </div>
            <div class="box__footer">
                <h2>Giới thiệu</h2>
                <a href="#" class="underline-hover">Công Ty TNHH LBL</a>
                <a href="#" class="underline-hover">Hệ thống cửa hàng</a>
                <a href="#" class="underline-hover">Tuyển dụng</a>
                <a href="home-page.php" class="underline-hover">Sản phẩm</a>
            </div>

            <div class="box__footer">
                <h2>Chương trình & Chính sách</h2>
                <a href="#" class="underline-hover">Chính sách ưu đãi</a>
                <a href="#" class="underline-hover">Chính sách bảo hành</a>
                <a href="#" class="underline-hover">Chính sách đổi trả</a>
                <a href="#" class="underline-hover">Chính sách bảo mật</a>
                <a href="#" class="underline-hover">Quy định thanh toán</a>              
            </div>

            <div class="box__footer">
                <h2>Tin tức</h2>
                <a href="#" class="underline-hover">LBLSTORE và báo chí</a>
                <a href="#" class="underline-hover">Sao Việt và khách hàng</a>
                <a href="#" class="underline-hover">LBLSTORE video</a>             
            </div>

            <div class="box_footer">
                <h2>Theo dõi chúng tôi</h2>
                <a href="https://www.facebook.com/LBLAuto/" target="_blank"><i class="fab fa-facebook-square"></i></a>
                <a href="https://twitter.com/LBLAuto" target="_blank"><i class="fab fa-twitter-square"></i></a>
                <a href="https://www.linkedin.com/" target="_blank"><i class="fab fa-linkedin"></i></a>
                <a href="https://www.instagram.com/lebaooloc/" target="_blank"><i class="fab fa-instagram-square"></i></a>
            </div>
        ...
        <div class="box__copyright">
            <hr>
            <p>&copy; 2023 LBL Web Design. All rights reserved. | Design by <b>Lê Bảo Lộc</b></p>
        </div>
    </footer>
    <div class="box-cart">
        <div class="cart">
